...
export const ChainIdToChain: Record<ChainId, Chain> = {
  ...
  [ChainId.Hyperliquid]: Chain.Hyperliquid,
  [ChainId.HyperliquidHex]: Chain.Hyperliquid,
...
export const EXPLORER_URLS: Record<Chain, string> = {
  ...
  [Chain.Fiat]: "",
  [Chain.Hyperliquid]: "https://app.hyperliquid.xyz/explorer",
