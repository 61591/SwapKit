...
function getNetworkInfo<C extends EVMChain>({ chain }: { chain: C }) {
  ...
  switch (chain) {
    ...
    case Chain.BinanceSmartChain:
      return { chainName: "BNB Smart Chain Mainnet", nativeCurrency: { decimals, name: "Binance Coin", symbol: "BNB" } };
     case Chain.Botanix:
      return { chainName: "Botanix Mainnet", nativeCurrency: { decimals, name: "Bitcoin", symbol: "BTC" } };
     case Chain.Core:
      return { chainName: "Core Blockchain Mainnet", nativeCurrency: { decimals, name: "Core", symbol: "CORE" } };
    case Chain.Corn:
      return { chainName: "Corn", nativeCurrency: { decimals, name: "Bitcorn", symbol: Chain.Corn } };
    case Chain.Gnosis:
      return { chainName: "Gnosis", nativeCurrency: { decimals, name: "xDAI", symbol: "XDAI" } };
    case Chain.HyperEVM:
      return { chainName: "HyperEVM", nativeCurrency: { decimals, name: "Hyperliquid", symbol: Chain.HyperEVM } };
    case Chain.Optimism:
    ...
    case Chain.Sonic:
      return { chainName: "Sonic Mainnet", nativeCurrency: { decimals, name: "Sonic", symbol: Chain.Sonic } };
    case Chain.Unichain:
